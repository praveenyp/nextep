...
const Slide = ({ imgUrl, t1, t2, t3, title, linkTo }) => {
	return (
		<div className="">
			<img src={imgUrl} alt="" className="h-[40vh] md:h-full w-[100%]" />
			<div className="absolute top-20 left-20 w-[70%] rounded  bg-white/[0.8] bg-none p-4 md:-top-40 md:left-20 md:max-w-none md:bg-transparent md:p-8 sm:mt-[300px] mt-0">
				<h2 className="text-2xl font-bold uppercase tracking-wider  text-cyan-900 md:text-6xl">
					{title}
				</h2>
				...
				<button className="mt-4 rounded-md bg-blue-700  md:px-8 px-4 md:py-3 py-2 capitalize text-white hover:bg-green-800">
