					...
					<div className="flex items-center justify-between h-20">
						<div className="flex items-center">
							<div className="flex-shrink-0">
								<Link to={'/'}>
									<img
										className="h-24 w-36 p-4 cursor-pointer"
										src={Logo}
										alt="Workflow"
									/>
								</Link>
							...
							<div className="hidden md:block ml-24  items-center">
								<div className="ml-10 flex items-baseline space-x-4">
									<Link
										to="/hardware"
										className=" hover:bg-green-700 text-gray-400 hover:text-white px-3 py-2 rounded-md text-base font-medium uppercase">
										Hardware
									</Link>
