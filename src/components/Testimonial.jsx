...
function Testimonial() {
  return (
    <div className="bg-gradient-to-r from-gray-900 to-gray-800">
      <h1 className="sm:text-6xl text-3xl sm:py-10 py-2  text-slate-400 flex justify-center">
        What People Says!
      </h1>

      <div className="flex flex-wrap items-center justify-evenly gap-2 ">
        <div className="sm:w-[30%] w-[90%] bg-slate-900 h-[300px] flex flex-col items-center justify-center my-10 rounded-xl shadow-xl shadow-black -skew-x-6">
          <RiDoubleQuotesL className="mr-[90%] text-red-600" />
          <span className="text-center mx-10">
            <p className="text-gray-400 skew-x-6">
          ...
          <div className="flex items-center justify-center">
            <span className="flex flex-row gap-2 text-sm text-cyan-800 skew-x-6">
