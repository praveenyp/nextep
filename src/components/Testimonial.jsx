        ...
        <div className="mx-auto max-w-[1340px] px-4 py-16 sm:px-6 sm:py-24 lg:mr-0 lg:pl-8 lg:pr-0">
          <div className="max-w-7xl items-end justify-between sm:flex sm:pr-6 lg:pr-8">
            ...
            <div className="mt-8 flex lg:mt-0">
              <button className="prev-button rounded-full border border-current p-3 text-green-600 transition-colors focus:bg-green-600 focus:text-white focus:outline-none">
              ...
              <button className="next-button ml-3 rounded-full border border-current p-3 text-green-600 focus:bg-green-600 focus:text-white focus:outline-none">
                  ...
                  <blockquote className="flex h-full flex-col justify-between bg-white p-12">
                    <div>
                      <div className="flex gap-0.5 text-white">
                        <span className="bg-pink-500 p-0.5">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5"
                            viewBox="0 0 20 20"
                      ...
                      <div className="mt-4">
                        <h3 className="text-2xl font-bold text-green-600 sm:text-3xl">
