...
function Consumable() {
  return (
    <div>
      <Navbar/>
      <div className='sm:h-screen h-[200px] bg-no-repeat' style={{backgroundImage:"url(https://images.unsplash.com/photo-1532186773960-85649e5cb70b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1742&q=80)"}}>
        <div>
